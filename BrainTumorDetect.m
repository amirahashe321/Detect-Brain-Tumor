...
% Last Modified by GUIDE v2.5 02-Mar-2022 22:39:27
...
function varargout = BrainTumorDetect_OutputFcn(~, ~, handles) 
...
area =[stats.Area];
high_denes_area = density > 0.5;
max_area = max(area (high_denes_area));
...
for i =1 : length(Bound)
    plot(Bound{i} (:,2),Bound{i} (:,1),'g','linewidth',1.75)
end
